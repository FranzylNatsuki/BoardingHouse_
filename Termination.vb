...
Public Class frmTermination
    ...
    Dim termDA As New MySqlDataAdapter
    ...
    Private Sub frmTermination_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        termSQLQuery = "SELECT * FROM rent_termination"
        ...
        Try
            ...
            Dim cb1 As MySqlCommandBuilder = New MySqlCommandBuilder(termDA)
            ...
            termDA.Fill(termDS, "rent_termination")
            ...
            dgv_rentTerm.DataSource = termDS
            dgv_rentTerm.DataMember = "rent_termination"
            dgv_rentTerm.AutoResizeColumns()
            'set the headers of the columns
            'modify this based on the number of attributes you have in the BORROWER table; attribute 1 starts at column 0
    ...
    Private Sub btn_add_Click(sender As Object, e As EventArgs) Handles btn_add.Click
        ...
        Try
            ...
            newRow("TerminationID") = txt_termID.Text
            newRow("TerminationDate") = cal_termDate.SelectionStart.Date
    ...
    Private Sub btn_update_Click(sender As Object, e As EventArgs) Handles btn_update.Click
        ...
        Try
            ...
            dt.Rows(row)("TerminationID") = txt_termID.Text
            dt.Rows(row)("TerminationDate") = cal_termDate.SelectionStart.Date
            ...
            MsgBox("The changes in the record were successfully saved.", MsgBoxStyle.Information, "Rental Termination")
            'Clear out the text boxes/combo box for new input/s
            clear()
            'set the cursor on the first textbox (borrower number)
            txt_termID.Focus()
            txt_termID.Enabled = True
    ...
    Private Sub btn_delete_Click(sender As Object, e As EventArgs) Handles btn_delete.Click
        ...
        answer = MsgBox("Are you sure you want to delete this record?", MsgBoxStyle.YesNo, "Rental Termination")
        If (answer = MsgBoxResult.Yes) Then
            Try
                ...
                MsgBox("The record was successfully deleted.", MsgBoxStyle.Information, "Rental Termination")
    ...
    Private Sub frmTermination_Click(sender As Object, e As EventArgs) Handles Me.Click
        btn_add.Enabled = True
        btn_delete.Enabled = False
        btn_update.Enabled = False
        txt_termID.Enabled = True
        txt_rtBoarder.Enabled = True
        clear()
    End Sub
    ...
    Private Sub dgv_rentTerm_MouseUp(sender As Object, e As MouseEventArgs) Handles dgv_rentTerm.MouseUp
        ...
        row = dgv_rentTerm.CurrentRow.Index
