...
Public Class frmRoomMt
    ...
    Private Sub btn_delete_Click(sender As Object, e As EventArgs) Handles btn_delete.Click
        ...
        answer = MsgBox("Are you sure you want to delete this record?", MsgBoxStyle.YesNo, "Room Maintanance")
        If (answer = MsgBoxResult.Yes) Then
            Try
                ...
                MsgBox("The record was successfully deleted.", MsgBoxStyle.Information, "Room Maintanance")
