...
Public Class frmFacilityMt
    ...
    Private Sub dgv_facility_MouseUp(sender As Object, e As MouseEventArgs) Handles dgv_facility.MouseUp
        ...
        cb_roomID.Text = dgv_facility.CurrentRow.Cells(3).Value.ToString
    ...
    Private Sub btn_add_Click(sender As Object, e As EventArgs) Handles btn_add.Click
        If txt_facilityID.Text.Trim() = "" Or cb_roomID.Text.Trim() = "" Then
            MsgBox("Key/s cannot be empty.", MsgBoxStyle.Exclamation, "Validation Error")
            clear()
            Exit Sub
        End If

        If Not IsNumeric(txt_facilityID.Text) Then
